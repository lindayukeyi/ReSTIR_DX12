...
namespace {
	...
	const char* kAccumNoisyDataShader = "Tutorial11\\preprocess.ps.hlsl";
	const char* kAccumFilteredDataShader = "Tutorial11\\postprocess.ps.hlsl";
	const char* kRegressionShader = "Tutorial11\\regressionCP.hlsl";
};
...
bool BlockwiseMultiOrderFeatureRegression::initialize(RenderContext* pRenderContext, ResourceManager::SharedPtr pResManager)
{
	...
	mpRegression = ComputeProgram::createFromFile("Tutorial11\\regressionCP.hlsl", "fit");
